    ...
    public partial class sqlserver : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ErpInvoiceId = table.Column<int>(type: "int", nullable: false)
                    ...
                    SecurityChecks = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ContactId = table.Column<int>(type: "int", nullable: true),
                    ErpSupplierName = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ErpInvoice", x => x.ErpInvoiceId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Days30 = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Days60 = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvoiceText = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NotesAI = table.Column<string>(type: "nvarchar(max)", nullable: false),
